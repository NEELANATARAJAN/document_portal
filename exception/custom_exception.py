...
class DocumentPortalException(Exception):
    def __init__(self, error_message, error_details):
        ...
        # Resolve exc_info (Supports: sys module, Exception Object or current content)
        ...
        # Walk to the last frame of the report to the most relevant location
        last_tb = exc_tb
